...
import { OnplaceDialog } from "./kiosk-onplace-dialog";

export { KioskDetailDialog, KioskDialog, KioskTypeDialog, KioskTypeDetailDialog, KioskVersionDialog, OnplaceDialog }