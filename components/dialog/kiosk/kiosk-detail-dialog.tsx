                            ...
                            <CardContent className="p-4">
                                ...
                                <div className="space-y-4">
                                    {kiosk.devices && kiosk.devices.length > 0 ? (
                                            ...
                                            <div key={device.deviceId} className="border rounded-md p-3">
                                                <div className="flex justify-between items-start">
                                                    <div className="flex-1">
                                                        ...
                                                        <p className="text-sm text-muted-foreground line-clamp-2">{device.description || "Không có mô tả"}</p>
                                                    </div>
                                        ...
                                        <div className="text-sm text-muted-foreground italic">Không có thiết bị</div>
                                    )}
                                </div>
                            </CardContent>
                        </Card>
