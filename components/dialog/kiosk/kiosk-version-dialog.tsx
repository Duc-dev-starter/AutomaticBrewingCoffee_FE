...
import { createKioskVersion, updateKioskVersion, getKioskTypes } from "@/services/kiosk";
                ...
                <form onSubmit={handleSubmit} className="px-8 py-8 pt-2 space-y-8">
                    ...
                    <div className="flex justify-between items-center pt-2">
                        ...
                        <div className="flex space-x-3">
                            ...
                            <Button
                                type="submit"
                                disabled={loading || !validFields.versionTitle || !validFields.versionNumber}
                                className={cn(
                                    "h-11 px-8 bg-primary text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105",
                                    (!validFields.versionTitle || !validFields.versionNumber || loading) && "opacity-60 cursor-not-allowed hover:scale-100",
                                )}
                            >
                                {loading ? (
                                    <>
